        ...
        <div className="rounded-sm bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="flex flex-wrap items-center h-screen justify-center">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="px-26 py-10 text-center">
                <Link className="mb-5.5 inline-block" href="/"></Link>

                <p className="2xl:px-20">Connect your sales</p>
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                  Sign In to Store Admin Interface
                </h2>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link
                      href="/register"
                      /* href="/auth/signup" */ className="text-primary"
                    >
                      Sign Up
                    </Link>
                  </p>
